...
public class MemberDAO {
	...
	public boolean isDuplicated(String id) {
		System.out.println("[시작] MemberDAO.isDuplicated()");
		// 결과를 담을 boolean 변수 result 를 false 로 초기화
		boolean result = false;
		...
		System.out.println("[종료] MemberDAO.isDuplicated() 결과: " + result);
		// 중복 여부 반환
		return result;
	}
	/*==============================================================
	...
	public boolean insertMember(MemberVO memberVO) {
		System.out.println("[시작] MemberDAO.insertMember()");
		...
		System.out.println("[종료] MemberDAO.insertMember() 결과: " + result);
		// 저장 결과 반환
		return result;
	}
}//MemberDAO
