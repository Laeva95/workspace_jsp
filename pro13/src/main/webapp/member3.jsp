...
<jsp:setProperty property="id" name="vo" value='<%=t( request.getParameter("id"%>'/>
<jsp:setProperty property="pwd" name="vo" value='<%=t( request.getParameter("pwd"%>'/>
<jsp:setProperty property="name" name="vo" value='<%=t( request.getParameter("name"%>'/>
<jsp:setProperty property="email" name="vo" value='<%=t( request.getParameter("email"%>'/>
<%
p
